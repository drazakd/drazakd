// src/components/roundDesigns/home/Titre.jsx
import React from 'react'

const Titre = ({title,subTitle}) => {
  return (
    <h1 className='font-titleFont font-bold txt-xl capitalize text-textColor relative z-10 px-6 py-3 borderBottom group'>
